require "__ModuleInserterER__/prototypes/item"
require "__ModuleInserterER__/prototypes/style"

local data_util = require("__flib__.data-util")

local frame_action_icons = "__ModuleInserterER__/graphics/frame-action-icons.png"
...
data:extend({
    ...
    },
    {
        ...
        style = 'green',
        icon = {
            filename = "__ModuleInserterER__/graphics/new-module-inserter-x32-white.png",
        ...
        small_icon = {
            filename = "__ModuleInserterER__/graphics/new-module-inserter-x24-white.png",
            priority = 'extra-high-no-scale',
            size = 24,
            scale = 1,
            flags = {'icon'},
    ...
    },
    {
        type = "selection-tool",
        name = "module-inserter",
        icon = "__ModuleInserterER__/graphics/module-inserter-icon.png",
        icon_size = 32,
        icon_mipmaps = 0,
